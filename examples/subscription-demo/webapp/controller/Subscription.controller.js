  ...
  function (Controller, MessageToast, MessageBox, JSONModel) {
    ...
    return Controller.extend("subdemo.controller.Subscription", {
      ...
      onPlanChange: function (oEvent) {
        ...
        // Update base price based on plan
        var aPrices = {
          basic: 99,
          professional: 299,
          enterprise: 999,
      ...
      // Date change - validate and calculate next billing
      ...
      // Auto-renew change with confirmation
      ...
      onPlanSelect: function (oEvent) {
        ...
        var oContext = oItem.getBindingContext("sub");
      ...
      calculatePricing: function () {
        ...
        // Calculate seat cost for per-seat pricing
        if (sPricingModel === "per-seat" && iSeatCount > 0) {
          fSeatCost = iSeatCount * 20; // €20 per seat
        }
        
        // Calculate usage cost for usage-based pricing
        if (sPricingModel === "usage" && iUsageQuota > 0) {
          fUsageCost = iUsageQuota * 0.1; // €0.10 per unit
        }
        
        // Adjust base price for billing frequency
        var fMultiplier = 1;
      ...
      // Formatter: Inverted boolean for visibility binding
